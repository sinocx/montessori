...
child2 = ChildNoValid.create!(first_name:"Anais", last_name: "Bacard", gender: "Féminin", birth_date: "20/02/2016", nationality: "Française", first_lang: "Francais", snd_lang: "Anglais", montessori_before: false, comment: "Aucun commentaire", subscription: sub2, child_atmosphere: 0, start_date: '01/07/2018')
...
child4 = ChildNoValid.create!(first_name:"Miaofen", last_name: "Chen", gender: "Féminin", birth_date: "20/02/2012", nationality: "Française", first_lang: "Francais", snd_lang: "Anglais", montessori_before: false, comment: "Aucun commentaire", subscription: sub10, child_atmosphere: 1, start_date: '01/07/2018')
...
ParentNoValid.create!(email: "J.Lesieur@hotmail.fr", first_name: "Julien", last_name: "Lesieur", lang: "Francais", situation:"Séparé(e)", job: "Finance", fiscal: "54000", address: "25 places jules ferry", zip_code: "92120", city: "Montrouge", phone: "0185785878", mobile: "0741758785", role: "Père", subscription: sub2)
ParentNoValid.create!(email: "M.Declarey@hotmail.fr", first_name: "Marina", last_name: "Declarey", lang: "Francais", situation:"Séparé(e)", job: "Hotesse", fiscal: "43000", address: "12 boulevard Foch", zip_code: "92120", city: "Montrouge", phone: "0185785878", mobile: "0741758785", role: "Mère", subscription: sub2)
